<template>
  <nav items-center w-full border-b-bluegray h-55 sm:h-50 text-gray-300 flex flex-col sm:flex-row justify-center gap-1
    sm:gap-8 select-none class="dark:bg-gradient-to-dark">
