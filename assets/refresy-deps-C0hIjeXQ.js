import{i as o}from"./mock-api-BDUNxN5J.js";import{P as h}from"./index-DmvVZzf-.js";import{a$ as e,U as D,Q as p,B as f}from"./antd-D-XvgdAE.js";import{d as r,k as u,G as t,f as m,u as d,c as g,r as F}from"./vue-bWmcvXqU.js";import{u as i}from"./index-OU5-Hpez.js";import"./entry/index-C2yXXbfE-1713597257644.js";import"./useContentViewHeight-ByP0kkZI.js";import"./useWindowSizeFn-rAoW7C_Y.js";import"./onMountedOrActivated-C5rGMWQz.js";const C=[{label:"Jack",value:"Jack"},{label:"Lucy",value:"Lucy"},{label:"Lutz",value:"Lutz"}],v=r({setup(){const a=m("Lutz"),{data:n,loading:l}=i(()=>o(a.value),{refreshDeps:[a]});return()=>u(p,{title:"Ref 依赖刷新"},{default:()=>[u(e,null,{default:()=>[u(e.Paragraph,null,{default:()=>[t("useRequest 提供了一个"),u(e.Text,{type:"danger"},{default:()=>[" ",t("options.refreshDeps")," "]}),t("参数，当它的值变化后，会重新触发请求。")]}),u(e.Paragraph,null,{default:()=>[u(e.Text,null,{default:()=>[u("pre",null,[`const select = ref('Lutz');
